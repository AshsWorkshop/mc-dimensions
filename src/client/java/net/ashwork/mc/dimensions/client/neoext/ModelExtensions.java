...
public interface ModelExtensions {
    ...
    ItemDisplayContext IN_SIFTER_THIRD_PERSON_LEFTHAND_DEFAULT = IdUtils.enumExt("in_sifter_third_person_lefthand_default", ItemDisplayContext::valueOf);
    ItemDisplayContext IN_SIFTER_THIRD_PERSON_LEFTHAND_SLIM = IdUtils.enumExt("in_sifter_third_person_lefthand_slim", ItemDisplayContext::valueOf);
    ItemDisplayContext IN_SIFTER_THIRD_PERSON_RIGHTHAND_DEFAULT = IdUtils.enumExt("in_sifter_third_person_righthand_default", ItemDisplayContext::valueOf);
    ItemDisplayContext IN_SIFTER_THIRD_PERSON_RIGHTHAND_SLIM = IdUtils.enumExt("in_sifter_third_person_righthand_slim", ItemDisplayContext::valueOf);
    ...
    Map<ItemDisplayContext, ItemTransform> TRANSFORMS = Util.make(() -> {
        ...
        Boolean2ObjectFunction<ItemTransform> thirdPerson = isSlim -> createTransform(
                new Vector3f(35f, 0f, 0f),
                new Vector3f(isSlim ? -5.5f : -6f, 0.25f, 1.75f),
                new Vector3f(0.375f, 0.375f, 0.375f)
        );
        builder.put(IN_SIFTER_THIRD_PERSON_LEFTHAND_DEFAULT, thirdPerson.apply(false));
        builder.put(IN_SIFTER_THIRD_PERSON_LEFTHAND_SLIM, thirdPerson.apply(true));
        builder.put(IN_SIFTER_THIRD_PERSON_RIGHTHAND_DEFAULT, thirdPerson.apply(false));
        builder.put(IN_SIFTER_THIRD_PERSON_RIGHTHAND_SLIM, thirdPerson.apply(true));
    ...
    static ItemDisplayContext sifterThirdPersonDisplay(ItemDisplayContext original, LivingEntity entity) {
        boolean isRightHand = original == ItemDisplayContext.THIRD_PERSON_RIGHT_HAND;
        if (entity instanceof ClientAvatarEntity avatar && avatar.getSkin().model() == PlayerModelType.SLIM) {
            return isRightHand ? IN_SIFTER_THIRD_PERSON_RIGHTHAND_SLIM : IN_SIFTER_THIRD_PERSON_LEFTHAND_SLIM;
        }

        return isRightHand ? IN_SIFTER_THIRD_PERSON_RIGHTHAND_DEFAULT : IN_SIFTER_THIRD_PERSON_LEFTHAND_DEFAULT;
    }
