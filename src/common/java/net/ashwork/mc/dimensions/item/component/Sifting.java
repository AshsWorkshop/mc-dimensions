...
public record Sifting(ItemStack stack, EquipmentSlot slot, ResourceKey<LootTable> loot, int tickDuration) {
    ...
    public static Sifting create(ItemStack siftingItem, InteractionHand hand, ResourceKey<LootTable> loot) {
        return new Sifting(siftingItem.copy(), hand.asEquipmentSlot(), loot, 200);
    }
