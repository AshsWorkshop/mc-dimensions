    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> output) {
        ...
        output.accept(
                key(Items.SAND), LootTable.lootTable()
                        ...
                        .withPool(
                                LootPool.lootPool().setRolls(BinomialDistributionGenerator.binomial(1, 0.2f))
                        ...
                        .withPool(
                                LootPool.lootPool().setRolls(BinomialDistributionGenerator.binomial(1, 0.01f))
                        ...
                        .withPool(
                                LootPool.lootPool().setRolls(BinomialDistributionGenerator.binomial(1, 0.0001f))
